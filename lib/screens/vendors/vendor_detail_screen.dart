  ...
  void _printInvoice(BuildContext context, PurchaseProvider pp) {
    ...
    js.context.callMethod('eval', ['''
      ...
      if(w){w.document.write('<html><head><title>Invoice - $escapedName</title><style>'
        ...
        +'</style></head><body>'
        +'<div class="header"><div><div class="logo">BILLOVA RETAIL</div><div style="font-size:12px;color:#666">Professional Billing System</div></div>'
        ...
        +'<div class="footer">Thank you for doing business with us!<br>Generated by Billova Retail System</div>'
